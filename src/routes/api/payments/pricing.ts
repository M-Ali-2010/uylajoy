...
export const Route = createFileRoute("/api/payments/pricing")({
  server: {
    handlers: {
      GET: async () => {
        return json({
          ...
          pricing: {
            featured: {
              ...
              "14days": {
                amount: PRICING.featured["14days"] / 100,
                currency: "UZS",
                label: "14 kun",
              },
              "30days": {
                amount: PRICING.featured["30days"] / 100,
                currency: "UZS",
                label: "30 kun",
              },
            },
            premium: {
              ...
              "14days": {
                amount: PRICING.premium["14days"] / 100,
                currency: "UZS",
                label: "14 kun",
              },
              "30days": {
                amount: PRICING.premium["30days"] / 100,
                currency: "UZS",
                label: "30 kun",
              },
            },
          ...
          benefits: {
            ...
            boost: ["E'lon yangi e'lonlar orasiga ko'tariladi", "Ko'rishlar soni oshadi"],
          },
        });
      },
    },
